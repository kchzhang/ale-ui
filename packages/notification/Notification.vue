<template>
  <Teleport to="body">
    ...
    >
      ...
      >
        <!-- 图标区域 -->
        <div v-if="showIcon" class="ale-notification__icon">
          <template v-if="icon">{{ icon }}</template>
          <template v-else>
            <svg v-if="type === 'success'" class="ale-notification__svg" viewBox="0 0 1024 1024">
            ...
            <svg v-else-if="type === 'warning'" class="ale-notification__svg" viewBox="0 0 1024 1024">
            ...
            <svg v-else-if="type === 'error'" class="ale-notification__svg" viewBox="0 0 1024 1024">
            ...
            <svg v-else class="ale-notification__svg" viewBox="0 0 1024 1024">
        ...
        <!-- 内容区域 -->
        <div class="ale-notification__content">
          <div v-if="title" class="ale-notification__title">{{ title }}</div>
          <div class="ale-notification__message">
        ...
        <button
          v-if="closable"
          class="ale-notification__close"
          type="button"
          aria-label="关闭"
          @click.stop="handleClose"
        >
          <svg class="ale-notification__close-icon" viewBox="0 0 1024 1024">
        ...
        <div
          ...
          class="ale-notification__progress"
          :style="progressStyle"
        />
      </div>
    </Transition>
...
<style scoped>
/* 仅保留 scoped 样式，主要样式在 Notification.css */
</style>
